...
async function update({ cwd, flags }) {
  ...
  for (const r of T.ROLES) {
    plan.push({ rel: `.agent/roles/${r}.yaml`, content: T.roleYaml(r, persona, detection), force });
  }
  ...
  process.stdout.write(
    "\n      always refreshed: stack.yaml, memory/codebase-map.md, checks/\n" +
    (force
      ? "      force-overwritten: roles/, templates/\n"
      : "      preserved (use --force to overwrite): roles/, templates/, conventions.yaml, manifest.yaml\n")
  );
